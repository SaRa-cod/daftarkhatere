...
<div class="view-memory">
      ...
      <div class="box-container">
        <?php
           $select_memory = $conn->prepare("SELECT * FROM `memory` WHERE user_id = ? AND category = 'memory'");
      ...
      echo '
      <div class="empty">
         <p>no memory added yet! <br> <a href="add-memory.php" class="btn" style="margin-top="1rem>add-memory</a></p>
      </div>
      ';
    }
       ?> 
